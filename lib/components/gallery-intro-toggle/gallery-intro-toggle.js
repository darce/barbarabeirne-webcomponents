...
var styles = "dax-sidebar[data-nav-open=false]+main[data-gallery-context] gallery-intro-toggle{pointer-events:none}@media(max-width: 810px){dax-sidebar[data-nav-open=false]+main[data-gallery-context] gallery-intro-toggle{pointer-events:auto}}gallery-intro-toggle{pointer-events:auto;display:inline-flex;align-items:center;justify-content:center;padding:4px 12px;background:#fff;color:#000;border:1px solid #000;box-shadow:4px 4px 0 rgba(0,0,0,.2);border-radius:0;font-size:14px;font-weight:500;letter-spacing:.08em;text-transform:uppercase;cursor:pointer;user-select:none;outline:none;transition:background .15s ease-out,border-color .15s ease-out,color .15s ease-out}gallery-intro-toggle:hover{background:#000;border-color:#000;color:#fff}gallery-intro-toggle:focus-visible{outline:1px solid #000;outline-offset:-1px}.gallery-intro{position:absolute;inset:0;padding:calc(16px*5) calc(16px*2) calc(16px*2) calc(16px*5);background:#fff;overflow-y:auto;clip-path:polygon(0 0, 0 160px, 0 0, 0 0);-webkit-clip-path:polygon(0 0, 0 160px, 0 0, 0 0);pointer-events:none;transition:clip-path .6s ease,-webkit-clip-path .6s ease;z-index:10;text-align:left}.gallery-intro h2{font-size:32px;padding-bottom:16px;text-align:center;line-height:1.2}.gallery-intro h3{font-size:18px;padding-top:16px;padding-bottom:16px}.gallery-intro p{padding-bottom:16px;line-height:1.6}.gallery-intro ul{list-style:disc;margin-left:16px;padding-bottom:16px}.gallery-intro li{padding-bottom:10px}[data-gallery-context].is-intro-open .gallery-intro{clip-path:polygon(0 0, 0 100%, 100% 100%, 100% 0);-webkit-clip-path:polygon(0 0, 0 100%, 100% 100%, 100% 0);pointer-events:auto;z-index:50}@media(min-width: 811px){.gallery-intro{padding-left:clamp(240px,20vw,320px)}}@media(max-width: 810px){.gallery-intro{padding-top:calc(3.5em + 3.5em);padding-left:16px;padding-right:16px}}\n";
