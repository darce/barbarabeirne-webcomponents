...
var styles = ":root{--duration-fast: 0.15s;--duration-normal: 0.3s;--duration-slow: 0.5s;--duration-clip: 0.6s;--duration-fade: 0.6s;--ease-default: ease;--ease-in-out: ease-in-out;--ease-out: ease-out}@media(prefers-reduced-motion: reduce){:root{--duration-fast: 0s;--duration-normal: 0s;--duration-slow: 0s;--duration-clip: 0s;--duration-fade: 0s}}:host{display:block;--dax-sidebar-breakpoint-nav: 810px}.dax-sidebar{position:fixed;top:0;left:0;z-index:9999;width:clamp(240px,20vw,320px)}:host([data-nav-open=false]) .dax-sidebar{pointer-events:none}:host([data-nav-open=false]) .dax-sidebar-header{pointer-events:auto}.dax-sidebar-backdrop{display:none;position:fixed;inset:0;background:rgba(0,0,0,.65);z-index:99;opacity:0;transition:opacity var(--duration-normal) var(--ease-out)}.dax-sidebar-header{background:#fff;display:flex;align-items:center;position:relative;z-index:10;min-height:3.5em;padding:0 8px;margin-right:6px}.masthead{flex:1;text-transform:uppercase;text-align:right;font-weight:700;font-size:18px;padding:0 24px 0 0;margin:0;margin-right:6px;white-space:nowrap}.masthead a{color:#000;text-decoration:none;padding:4px 8px}.masthead a:hover{background:#666;color:#fff}.masthead a:focus,.masthead a:focus-visible{outline:1px solid #000;outline-offset:-1px}.dax-sidebar-toggle{background:#fff;border:none;cursor:pointer;color:#000}.dax-sidebar-toggle:hover{background:#666;color:#fff}.dax-sidebar-toggle:focus,.dax-sidebar-toggle:focus-visible{outline:1px solid #000;outline-offset:-1px}.dax-sidebar-toggle .material-symbols-sharp{font-size:24px;font-family:\"Material Symbols Sharp\";font-weight:400;font-style:normal;font-variation-settings:\"FILL\" 0,\"wght\" 400,\"GRAD\" 0,\"opsz\" 48;display:inline-block;transition:transform var(--duration-fast) var(--ease-out)}:host([data-nav-open=true]) .dax-sidebar-toggle .material-symbols-sharp{transform:rotate(90deg)}@media(max-width: 810px){.dax-sidebar{width:80%;z-index:100}.dax-sidebar-header{position:relative;top:0;left:0;width:100vw;z-index:100}.masthead{text-align:right}:host([data-nav-open=true]) .dax-sidebar-backdrop{display:block;opacity:1}}\n";
