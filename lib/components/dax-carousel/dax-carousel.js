...
function _attachEventListeners() {
  ...
  this.addManagedListener(document, 'dax-nav-toggle', function (event) {
    ...
    if ((_event$detail = event.detail) !== null && _event$detail !== void 0 && _event$detail.isOpen && ((_event$detail2 = event.detail) === null || _event$detail2 === void 0 ? void 0 : _event$detail2.source) !== 'init' && _classPrivateFieldGet2(_state, _this4).timer) {
      _assertClassBrand(_DaxCarousel_brand, _this4, _stop).call(_this4);
    }
  });
}
