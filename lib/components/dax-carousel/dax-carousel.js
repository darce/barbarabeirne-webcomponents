...
function _positionControls(slide) {
  ...
  var updatePosition = function updatePosition() {
    ...
    if (dotsContainer) {
      dotsContainer.style.top = "".concat(imgTop + imgHeight, "px");
    }
