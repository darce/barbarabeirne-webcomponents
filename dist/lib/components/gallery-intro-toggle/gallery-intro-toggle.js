...
function _initButton() {
  ...
  _classPrivateFieldGet2(_state, this).headerElement = this.closest('header.gallery-header');
...
function _attachEventListeners() {
  ...
  this.addManagedListener(document, 'dax-caption-close', function () {
    var _classPrivateFieldGet2$1;
    (_classPrivateFieldGet2$1 = _classPrivateFieldGet2(_state, _this2).headerElement) === null || _classPrivateFieldGet2$1 === void 0 || _classPrivateFieldGet2$1.setAttribute('data-header-collapsed', '');
  });
}
function _setOpen(isOpen) {
  ...
  var _classPrivateFieldGet3 = _classPrivateFieldGet2(_state, this),
    ...
    introSection = _classPrivateFieldGet3.introSection,
    headerElement = _classPrivateFieldGet3.headerElement;
  _classPrivateFieldGet2(_state, this).isOpen = isOpen;
  ...
  if (isOpen) {
    headerElement === null || headerElement === void 0 || headerElement.removeAttribute('data-header-collapsed');
  }
}
function _toggle() {
